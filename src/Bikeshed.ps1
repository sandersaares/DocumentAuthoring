...
# Currently this is only needed for PowerShell Desktop because PowerShell Core has some default list we need to use.
$references = @(
...
if (!$bikeshedTypeIsDefined) {
    # In PowerShell Core, we need to use its default list of reference assemblies.
    # In PowerShell Desktop, we need to supply our own.
